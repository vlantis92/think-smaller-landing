export const Approach = () => {
  ...
  return <section className="py-16 bg-muted/30 md:py-[67px]">
      <div className="container-narrow">
        <div className="space-y-12">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {principles.map((principle, index) => <div key={index} className="group p-6 bg-card border border-border/20 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:border-accent/30 hover:bg-accent/5 cursor-pointer">
